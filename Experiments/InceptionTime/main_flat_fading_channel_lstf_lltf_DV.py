...
data_name_arr = ['chen_feature_normal', 'my_lstf_feature_normal', 'my_lltf_feature_normal']
# data_name_arr = ['my_lltf_feature_normal']

nb_epochs = 50
if True:
    for heihei, data_name1 in enumerate(data_name_arr):
            ...
            for rx_test_arr_vld in test_arr:
                for exp_seed in range(5):
                    ...
                    if data_name1 == 'chen_feature_normal':
                        ...
                        ori_len = 12 * channel_num
                    elif data_name1 == 'my_lltf_feature_normal':
                    ...
                    if local_vld == True:
                        ...
                        data_train_vld = np.zeros([ori_len, 400000], dtype=float)
                    ...
                    print('#############', 'feature = ',  data_name1, ', train = ', rx_train_arr+1, ', test = ', rx_test_arr_vld+1, ', exp_idx = ', exp_seed + 1,
                          '#############')
