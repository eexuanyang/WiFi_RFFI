    ...
    for rx_train_arr in rx_train_arr_total:
        ...
        for exp_seed in range(seed_num):
            ...
            reduce_lr = ReduceLROnPlateau(monitor='val_accuracy', factor=0.5, patience=60,
                                                          min_lr=0.0001)
            file_path = 'results\\frequency_selective_fading_best_model.hdf5'
            ...
            tf.keras.models.save_model(model, 'results\\transformer_offline.h5')
...
mdict = {'acc_240609_LSTM_dense_layer_same_rx_arr': class_acc_same_rx_arr}
savemat('acc_240609_LSTM_dense_layer_same_rx_arr.mat', mdict)
mdict = {'acc_240609_LSTM_dense_layer_diff_rx_arr': class_acc_diff_rx_arr}
savemat('acc_240609_LSTM_dense_layer_diff_rx_arr.mat', mdict)