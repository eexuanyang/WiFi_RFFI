...
# rx_train_arr_total = np.array([0, 1])
...
for rx_test_arr_vld in test_arr:
    ...
    for rx_train_arr in rx_train_arr_total:
        ...
        for exp_seed in range(seed_num):
            ...
            reduce_lr = ReduceLROnPlateau(monitor='val_accuracy', factor=0.5, patience=60, #根据InceptionTime修改的代码
                                                          min_lr=0.0001)
...
mdict = {'acc_240517_LSTM_dense_layer_same_rx_arr': class_acc_same_rx_arr}
savemat('acc_240517_LSTM_dense_layer_same_rx_arr.mat', mdict)
mdict = {'acc_240517_LSTM_dense_layer_diff_rx_arr': class_acc_diff_rx_arr}
savemat('acc_240517_LSTM_dense_layer_diff_rx_arr.mat', mdict)
